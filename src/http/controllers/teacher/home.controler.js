...
module.exports = {
  index: async (req, res) => {
    ...
    console.log(message);
    res.render("teacher/home/index", { user, type, message });
  },
  infor: async (req, res) => {
    const message = req.flash("message");
    const user = req.user;
    ...
    res.render("teacher/products/index", { message, user, type,providerFb,providerGg,providerGh });
  },
  ...
  changePass:async(req,res)=>{
    const message = req.flash("message")
    const user = req.user
    res.render("teacher/home/changePass",{user, message})
  },
